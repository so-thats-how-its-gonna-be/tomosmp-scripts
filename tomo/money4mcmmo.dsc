money4mcmmo:
    ...
    events:
        after mcmmo player levels up skill:
            ...
            - narrate "<gold><bold>You earned $<[money_gain]> for reaching level <green><bold><context.new_level> <gold><bold>in <light_purple><bold><context.skill.to_titlecase><gold><bold>!"
