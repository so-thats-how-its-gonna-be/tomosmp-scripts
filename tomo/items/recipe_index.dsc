        ...
        after script reload:
            ...
            - foreach <server.flag[recipes_index.recipes]> as:recipe:
                ...
                - choose <[recipe.type]>:
                    ...
                    - case shapeless:
                        - define "book_pages:->:<[page_title]><n><&b>Shapeless Recipe<n><&7>Input: <n><[recipe.input].as[list].parse_tag[<[parse_value].proc[item_name]>].proc[compress_list].separated_by[<white>, <white>]>"
                    - case brewing:
